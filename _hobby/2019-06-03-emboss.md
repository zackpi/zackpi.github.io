...
Thanks for reading! Check out the github repo for this project for the full code [here](https://github.com/), and also take a look at Ed's [other projects](https://edho-design.github.io) because he makes cool stuff. Before you go, here is another example of the program output vs the final paper version for a [Princess Mononoke poster](https://edho-design.github.io):
